...
<?php
		...
		$header = array("Manage Users", 
						"Leave Messages", 
						"Edit User Information"
						);
		$text =   array("Using this application, you'll learn how to add, remove and edit users for the application.",
...
?>
	<div class="container-fluid">
		<div class="jumbotron">
			...
			<p>Welcome!  I've built a cool application using a MVC framework -- specifically CodeIgniter.</p>
